<template>
    <section>
        <div class="mt-4  text-orange-500 " >
            <h2 class="pb-2 text-3xl font-semibold text-center md:text-left px-5 uppercase">Who are <span class="">Carr & Son?</span></h2>
            <div class="px-5 text-xl text-justify  text-gray-900 " style="">
                <article>
                    <p>
