<template>
    <section>
        <div class="mt-4  text-gray-700 rounded border" style="background-color: #ccbca9;  border-color: #ccbca9; border-width: 2px;">
            <h2 class="pb-2 text-2xl font-semibold text-center md:text-left p-2">Who are <span class="font-bold">Carr & Son</span></h2>
            <div class="p-5 text-lg  text-gray-900 bg-gray-50" style="">
                <article>
                    <p>
